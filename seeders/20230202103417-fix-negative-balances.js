...
module.exports = {
  async up (queryInterface, Sequelize) {
    const incorrectCampaigns = await queryInterface.sequelize.query(
      ...
      WHERE credit_amount < 0 AND closed = false;`
    );
      ...
      try {
        ...
        `, {
          replacements: {
            ...
            comment: `Fix negative balances in open campaign accounts: set campaign balance from ${credit_amount} to ${correct_balance}`,
